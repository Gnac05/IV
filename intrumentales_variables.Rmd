...
| `cb_person_default_on_file` | Historique de défaut de paiement (True/False) | Discrète |
...
# Identification des variables endogènes
...
## Analyse de la matrice de corrélation (focalisée sur $loan\_status$)
...
3. $loan\_int\_rate$ : Moins suspecte mais corrélée avec d'autres explicatives.

# Régression de Variables Instrumentales
...
- Instruments faibles : Le test montre une statistique de 159.743 avec une p-value < 2e-16, ce qui signifie que l'instrument utilisé ($cb\_person\_cred\_hist\_length$) sont forts.
...
# Introduction complète à l'utilisation du package $ivreg$
...
## Modèle de Régression IV avec `ivreg`
